...
<section class="section-top-60 section-sm-top-90">
    <div class="container">
        <div class="rd-navbar-fixed--hidden center-block">
            <img src="{{ asset('styleWeb/images/logo.png') }}" alt=""
                 width="70%" style="margin-left: 10%;"/>
        </div>
        <div class="row grid-system-row offset-top-32">
            <div class="col-xs-6">
                <p style="font: bold; text-align: justify">
                ...
                <p style="font: bold; text-align: justify"">Asociados en Argentina con Jorge A. Lavanchy y Jeannette Negret, que añaden a la
                    empresa un profundo
            ...
            <div id="imagePPal" class="col-xs-6">
